...
import BackU from "../assets/images/backup.png";
...
export const MovieDetail = () => {
  ...
  useEffect(() => {
    async function fetchMovie(){
      const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=af2c313beb58700c8b020ebeeedc0297`);
      ...
      <section className='flex justify-around flex-wrap py-5'>
        ...
        <div className='max-w-2xl text-gray-700 text-lg dark:text-white'>
          ...
          <p className='my-4'>
            ...
            <a href={`https://www.imdb.com/title/${movie.imdb_id}`} target="_target" rel="noreferer">{movie.imdb_id} </a>
          </p>
